...
public final class Permission {
    ...
    public static List<String[]> getAllGroups() {
        ...
        list.add(Group.CALENDAR);
        list.add(Group.CAMERA);
        list.add(Group.CONTACTS);
        list.add(Group.LOCATION);
        list.add(Group.MICROPHONE);
        list.add(Group.PHONE);
        list.add(Group.SENSORS);
        list.add(Group.SMS);
        list.add(Group.STORAGE);
        return list;
    }
        ...
        for (String permission : permissions) {
            switch (permission) {
                ...
                case SYSTEM_ALERT_WINDOW: {
                    String message = context.getString(R.string.permission_alert_window);
                    if (!textList.contains(message)) {
                        textList.add(message);
                    }
                    break;
