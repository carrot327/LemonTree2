 ...
 * <p>
 * fit to System Overlay Permission Activity
 */
...
public class OverlaySettingPage {
    ...
    public OverlaySettingPage(Context context) {
    ...
    private boolean meiZuApi(int requestCode) {
        ...
        overlayIntent.putExtra("packageName", mContext.getPackageName());
        overlayIntent.setComponent(new ComponentName("com.meizu.safe", "com.meizu.safe.security.AppSecActivity"));
        try {
            Activity a = (Activity) mContext;
            a.startActivityForResult(overlayIntent, requestCode);
        } catch (Exception e) {
            return false;
        }
        return true;
    ...
    private boolean defaultApi(int requestCode) {
        ...
        manageIntent.setData(Uri.fromParts("package", mContext.getPackageName(), null));
        try {
            Activity a = (Activity) mContext;
            a.startActivityForResult(manageIntent, requestCode);
        } catch (Exception e) {
            return false;
        }
        return true;
